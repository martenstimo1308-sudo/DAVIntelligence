...
- Analytics gebruikt Google Analytics 4 met Measurement ID `G-GFJ072TDH3` en Google Consent Mode v2 advanced. De Google-tag start met alle opslag denied; na analytics-toestemming wordt alleen `analytics_storage` granted.
